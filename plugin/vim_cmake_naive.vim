...
command! -nargs=0 CMakeShowPreview call vim_cmake_naive#show_preview()
command! -nargs=0 CMakeHidePreview call vim_cmake_naive#hide_preview()
command! -nargs=0 CMakeCancel call vim_cmake_naive#cancel()
